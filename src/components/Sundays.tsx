...
function Sundays({ text }: { text: PortableTextBlock[] }) {
  return (
    <div className="grid flex-shrink-0 place-items-center px-8">
      <div className="flex max-w-lg flex-col gap-12">
        <div className="flex flex-col flex-wrap items-start justify-between gap-4 md:flex-row md:items-center">
          <h2 className="text-text-inverse text-3xl font-bold">Sundays</h2>
          <a
            href="/sermons"
        ...
        <RichText
          className="text-text-inverse flex flex-col gap-4 text-lg"
          value={text}
        />
      </div>
    </div>
